...
export const EFFECT_FIELDS = [
  ...
  { key:'unlock_type',       label:'Unlock type',       type:'select', group:'Flags',
    options:['',
      ...
      'full_differential',
      'front_bumper_downforce',
      'rear_wing_downforce',
      'aero',
    ] },
  { key:'compound_type',     label:'Compound type',     type:'select', group:'Flags',
    options:['','Stock','Street','Sport','Horizon Semi-Slick Race','Semi-Slick','Race Slick','Rally','Snow','Drift','Drag','Off-Road'] },
